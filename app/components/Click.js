...
class PSPC extends React.Component {
    ...
    constructor (props) {
        ...
        this.handleToggleUserManagement = this.handleToggleUserManagement.bind(this)
    }
    ...
    handleToggleUserManagement() {
        this.setState({toggleUserManagement:!this.state.toggleUserManagement});
    }
    ...
    render () {
        ...
        <div style={{display:'flex',width:'100%',height:'inherit',padding:20,fontFamily:'Quattrocento Sans'}}>
            ...
            <div style={{border:'1px solid #18c44b',display:'flex',flexDirection:'column',width:'50%',height:'inherit',margin:2,padding:0}}>
                ...
                <div style={{border:'0px solid lightgray',padding:3,textAlign:'center',fontSize:'120%',backgroundColor:'#6CC0E5',color:'white'}}>tree</div>
                <div style={{padding:10, height:'inherit',overflow:'scroll'}}>
                    <Node
                        key={treeData.name+0}
                        index={0}
                        tree={treeData}
            ...
            <div style={{border:'0px solid #18c44b',display:'flex',flexDirection:'column',width:'50%',height:'inherit',margin:2,padding:0,boxSizing:'border-box'}}>
                ...
                <div style={{position:'relative',paddingTop:3,paddingBottom:3,textAlign:'center',fontSize:'120%',backgroundColor:'#18c44b',color:'white',cursor:'pointer'}}
                    onMouseDown={this.handleToggleUserManagement}>
                    user management
                    <span style={{position:'absolute',right:5}}>
                        <Motion style={{deg: spring(this.state.toggleUserManagement ? 180 : 0, {stiffness: 400, damping: 60})}}>
                            {({deg}) => 
                ...
                <Motion style={{x: spring(this.state.toggleUserManagement ? 90 : 0, {stiffness: 400, damping: 60}),
                    opacity: spring(this.state.toggleUserManagement ? 1 : 0, {stiffness: 400, damping: 60})}}>
                    {({x,opacity,padding,display,zindex}) => 
                    <div style={{ border:'1px solid #18c44b', padding: 0, opacity: `${opacity}`, maxHeight: `${x}vh`}}>
                ...
                <div style={{width:'100%'}}>
                    ...
                    <div style={{position:'relative',paddingTop:3,paddingBottom:3,textAlign:'center',fontSize:'120%',marginTop:4,backgroundColor:'#18c44b',color:'white'}}
                ...
                <div style={{border:'1px solid #18c44b',display:'flex',flexDirection:'column',width:'stretch',height:'inherit',marginTop:4,padding:0,boxSizing:'border-box',zIndex:100}}>
                        ...
                        <div style={{padding:10,margin:0,overflow:'auto'}}>
