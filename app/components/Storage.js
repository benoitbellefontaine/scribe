...
class Storage extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = { data:null, hits: null, email: null, username:'bellefob', dept: null, region:null, modif:false, error:null };
    ...
    handleSubmit(event) {
        alert('handleSubmit was calleded');
    ...
    modifYes() {
        ...
        if (data===null) {
            ...
            var index = data.indexOf(this.state.email);
            if (index!=-1) {
                data.splice(index,1);
            }
            data.push({
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{textAlign:'center',fontFamily:'Quattrocento Sans'}}>
                      Locally manage user credentials using Local Storage
                    </p>
                    ...
                    {
                        this.state.modif && 
                            <div style={{border:'1px solid lightgray',textAlign:'center',position:'absolute',bottom:5,padding:5}}>
                                Save modifications ? 
                    ...
                    {
                        this.state.error && 
                            <div style={{backgroundColor:'rgba(255,0,0,0.1)',border:'1px solid rgba(255,0,0,0.4)',textAlign:'center',position:'absolute',bottom:5,padding:7}}>
                                {this.state.error}
                            </div>
                    }
