...
class Followup extends React.Component {
    ...
    handleOutlook (language,ticket,ftext,etext,fname,agent) {
        ...
        location.href= (language === 'French') 
            ? "mailto:"+email+"?subject="+"SUIVI - " + ticket + " - FOLLOW UP"+"&body="+bonjour+ftext+"%0D%0A%0D%0A"+etext+"%0D%0A%0D%0A"+signature
            : "mailto:"+email+"?subject="+"FOLLOW UP - " + ticket + " - SUIVI"+"&body="+bonjour+etext+"%0D%0A%0D%0A"+ftext+"%0D%0A%0D%0A"+signature;
    ...
    render () {
        ...
        return (
            <article style={{height:'inherit',display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',fontFamily: 'Quattrocento Sans'}}>
                ...
                <section style={{backgroundColor:'white',boxShadow: '2px 2px 5px rgb(220,220,220)',padding:10}} className='text-section'>
                    ...
                    {/* INJECT */}
                    <div style={{padding:5,border:'0px solid #93bfe0',backgroundColor:'white',display:'flex',borderBottom:'1px solid lightgray',paddingBottom:5}}>

                        <div style={{padding:'5px',flexBasis:'20em'}}>
                        ...
                        <div style={{padding:'5px'}}>
                            <div style={{padding:'5px',backgroundColor:'white',color:'black',marginBottom:'0px',textAlign:'center',border:'1px solid lightgray'}}>ID</div>
                                <form style={{margin:0}}>
                                    <div className="radio">
